...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset('css/summernote.css')?>" type="text/css">
    ...
    <script src="<?php echo asset('js/vendor/damn-uploader.js')?>" type="text/javascript"></script>
